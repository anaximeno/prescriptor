...
public class Constants {
    ...
    public static final String ENDPOINT_PHYSICIAN_INFO_CONTACT_NAME = "";
    public static final String ENDPOINT_PHYSICIAN_INFO_CONTACT_URL = "";
    public static final String ENDPOINT_PHYSICIAN_INFO_CONTACT_EMAIL = "";

    public static final String ENDPOINT_PHYSICIAN_INFO_LICENCE_NAME = "";
    public static final String ENDPOINT_PHYSICIAN_INFO_LICENCE_URL = "";
